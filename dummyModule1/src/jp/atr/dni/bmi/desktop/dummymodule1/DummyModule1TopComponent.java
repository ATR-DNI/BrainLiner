...
public final class DummyModule1TopComponent extends TopComponent implements PropertyChangeListener {
    ...
    private void setTextToList() {
        ...
        if (this.channel.getType() == ChannelType.ANALOG) {
            ...
            defaultListModel.addElement("------- Analog Size : " + allValues.size() + " --------");
            ...
            for (int ii = 0; ii < allValues.size(); ii++) {
                ...
                defaultListModel.addElement("------- Values Size : " + oneRow.size() + "--------");
            ...
            defaultListModel.addElement("------- Neural Size : " + timeStamps.size() + " --------");
            ...
            defaultListModel.addElement("------- Segment Size : " + values.size() + " --------");
            ...
            defaultListModel.addElement("------- Event Size : " + events.size() + " --------");
